...
def genere_vecteurs_aleatoires(n, m) : 
    # Segment 1 :
    v1 = np.array([])
    v2 = np.array([])
    v3 = np.array([])
...
# Vecteurs :
def affiche_vecteurs(v1, v2, v3, v4) :
...
# Tests des calculs pour l'article principal :
def test_calculs_segments(v1, v2, v3, v4, v5, v6, v7, v8) :
...
if __name__=="__main__":
    v1, v2, v3, v4, v5, v6, v7, v8 = genere_vecteurs_aleatoires(10, 8)
    affiche_vecteurs(v1, v2, v3, v4)
    G = test_calculs_segments(v1, v2, v3, v4, v5, v6, v7, v8)
    affiche_graphe(G)
